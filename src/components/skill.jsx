  ...
  return (
    <>
      <div
        ...
        id='skill'>
        <div className='text-6xl font-bold text-blue-900 text-center leading-tight max-lg:pt-0 mb-4'>My Skills.</div>
        ...
        <div className='text-6xl font-bold text-blue-900 text-center leading-tight mt-20 mb-4'>The Tech Stacks.</div>
        <div className='h-[20px] w-[150px] bg-orange-500'></div>
