  ...
  return (
    <>
      <div
        ...
        id='about'>
        <div className='text-8xl font-bold text-blue-900 text-right leading-tight max-lg:pt-0 mb-4'>About Me.</div>
        <div className='h-[20px] w-[150px] bg-orange-500'></div>
        <div className='text-2xl font-medium text-gray-700 pt-8 pr-8 text-justify leading-normal'>
          Hello...
